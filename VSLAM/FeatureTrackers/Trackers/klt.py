...
class KLTTracker(ABCFeatureTracker):
    ...
    def track(self, camera1, camera2) -> Tuple:
        ...
        mask_left = self.filter_matching_inliers(tracking_info["kpoints2d_left_prev"],
                                                 tracking_info["kpoints2d_left_cur"], 
                                                 camera1.kl)
        mask_right = self.filter_matching_inliers(tracking_info["kpoints2d_right_prev"],
        ...
        tracking_info["kpoints2d_left_prev"] = tracking_info["kpoints2d_left_prev"][mask]
        tracking_info["kpoints2d_right_cur"] = tracking_info["kpoints2d_right_cur"][mask]
        tracking_info["kpoints2d_right_prev"] = tracking_info["kpoints2d_right_prev"][mask]
